...
<body>
    <section id="container">
        ...
        <div class="card">
            ...
            <div class="image">
                <img src="" style="display: none;" alt="" id="image-upload">
            </div>
            <form action="<?= BASEURL?>/product/insert" method="post" enctype="multipart/form-data">
                ...
                <label for="nama">
                    ...
                    <input type="text" name="nama-produk" id="nama">
    ...
    <script src="<?= BASEURL; ?>/js/addData.js"></script>
</body>
</html>